...
#ifndef _misc__mem_safe__h_
#define _misc__mem_safe__h_
...
extern int sys_mem_probe(void *p, int perm, size_t num_bytes, void *buf);
...
extern int sys_mem_safe_read(void *src, char *buf, size_t num_bytes,
								int width);
...
extern int sys_mem_safe_write(void *dest, char *buf, size_t num_bytes,
								int width);
...
extern int sys_mem_safe_write_to_text_section(void *dest, char *buf,
												size_t num_bytes);
...
extern int sys_mem_safe_region_add(void *addr, size_t num_bytes, int perm);
#else
static inline int sys_mem_safe_region_add(void *addr, size_t num_bytes,
											int perm)
{
	return 0;
}
